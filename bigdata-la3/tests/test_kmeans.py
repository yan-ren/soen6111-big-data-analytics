...
from answers.answer import kmeans
...
def test_case2():
    res = [
        ["ab", "az", "bc", "ca", "co", "id", "mt", "nm", "nv", "or", "ut", "wa", "wy"],
        [
            "ak",
            "al",
            "ar",
...
def test_case3():
    res = [
        ["ct", "dc", "de", "ky", "ma", "md", "nj", "ny", "pa", "ri", "va", "wv"],
        ["me", "nb", "nf", "nh", "ns", "qc", "vt"],
        ["ak", "dengl", "fraspm", "hi", "lb", "nt", "nu", "pr", "vi", "yt"],
        ["co", "mt", "wy"],
        ["nd", "ne", "nm", "sd"],
        ["ia", "il", "in", "ks", "mo", "ok"],
        ["bc"],
